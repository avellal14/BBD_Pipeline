...
print ("CODE RUNNING!")
os.environ['PATH'] = os.path.join('C:', os.sep, 'Users', 'yheng', 'AppData', 'Local', 'Continuum', 'anaconda2', 'openslide-win64-20171122','bin') + ';' + os.environ['PATH']
#"C:/Users/yheng\AppData\Local\Continuum\anaconda2\openslide-win64-20171122\li" + ";" + os.environ['PATH']
